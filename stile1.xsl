                    ...
                    <xsl:when test="name() = 'persName'">
                        ...
                        <xsl:element name="span">
                            ...
                            <xsl:element name="img">
                                ...
                                <xsl:text></xsl:text>
                                <span>
                                    <xsl:value-of select="//tei:person[concat('#', @xml:id) = current()/@ref]/tei:birth//tei:settlement[@type='municipality']" />
                                </span>
                                <xsl:text>, </xsl:text>
                        ...
                        <xsl:if test="//tei:person[concat('#', @xml:id) = current()/@ref]/tei:death">
                            <xsl:element name="span">
                                ...
                                <xsl:element name="img">
                                    ...
                                    <xsl:text></xsl:text>
                                    <span>
                                        <xsl:value-of select="//tei:person[concat('#', @xml:id) = current()/@ref]/tei:death//tei:settlement[@type='municipality']" />
                                    </span>
                                    <xsl:text>, </xsl:text>
